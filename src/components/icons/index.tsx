...
export const IconNews: JSX.Element = (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    className='h-6 w-6'
    fill='none'
...
export const IconSun = (size = 6, className?: string): JSX.Element => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
...
export const IconMoon = (size = 6, className?: string): JSX.Element => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    className={className ?? `w-${size} h-${size}`}
    fill='none'
...
export const IconWarning = (size = 6, className?: string): JSX.Element => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
